public class MainListe {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("Nb d'occurrences de 3 dans L1 = " + L1.nombreDe(3));
        System.out.println("Nb d'occurrences de 6 dans L2 = " + L2.nombreDe(6));
        ...
        System.out.println("L4 clone de L5 = " + L4.estCloneDe(L5));
        Liste L4clone = new Liste(L4);
        System.out.println("L4clone clone de L4 = " + L4.estCloneDe(L4clone));
//
